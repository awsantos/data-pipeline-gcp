...
PROJECT_ID = os.environ.get("GCP_PROJECT_ID", "datapipeline01-377016")
BUCKET_1 = os.environ.get("GCP_GCS_BUCKET_1", "data-pipeline-insight-combustiveis-brasil-curated")
